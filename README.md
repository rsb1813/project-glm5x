...
- `k3x_cuda_glm5x_real_expert_bench` now executes one real nonzero GLM expert through CUDA. The latest FP32 resident sample measured 275 µs warm median with CPU max error `8.38e-9`; BF16-rounded saved resident memory but measured 28.15 ms and remains experimental.
