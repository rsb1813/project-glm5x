...
- GitHub status: the active account `rsb1813`, HTTPS origin, and `repo`/`workflow` scopes are live outside the sandbox. Evidence is committed and the branch is ready for its final state commit, external push, and stacked draft PR.
