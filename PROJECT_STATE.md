...
- GitHub: `9f3efb3` Linux correctness `31842485871` and CodeQL `31842485790` both completed successfully. The recurring red Linux notification is historical, not an active failure on `main`.
